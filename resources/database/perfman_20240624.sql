...
-- ----------------------------
-- Table structure for perfman_alert_records
-- ----------------------------
DROP TABLE IF EXISTS `perfman_alert_records`;
CREATE TABLE `perfman_alert_records`  (
  ...
  CONSTRAINT `perfman_alert_records_ibfk_1` FOREIGN KEY (`rule_id`) REFERENCES `perfman_alert_rules` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '触发的告警事件记录' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for perfman_alert_rules
-- ----------------------------
DROP TABLE IF EXISTS `perfman_alert_rules`;
CREATE TABLE `perfman_alert_rules`  (
...
-- ----------------------------
-- Table structure for perfman_clusters
-- ----------------------------
DROP TABLE IF EXISTS `perfman_clusters`;
CREATE TABLE `perfman_clusters`  (
...
-- ----------------------------
-- Table structure for perfman_configurations
-- ----------------------------
DROP TABLE IF EXISTS `perfman_configurations`;
CREATE TABLE `perfman_configurations`  (
...
-- ----------------------------
-- Table structure for perfman_internal_messages
-- ----------------------------
DROP TABLE IF EXISTS `perfman_internal_messages`;
CREATE TABLE `perfman_internal_messages`  (
  ...
  CONSTRAINT `perfman_internal_messages_ibfk_2` FOREIGN KEY (`recipient_id`) REFERENCES `perfman_user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户站内消息通讯' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for perfman_menus
-- ----------------------------
DROP TABLE IF EXISTS `perfman_menus`;
CREATE TABLE `perfman_menus`  (
...
-- ----------------------------
-- Table structure for perfman_node_operation_logs
-- ----------------------------
DROP TABLE IF EXISTS `perfman_node_operation_logs`;
CREATE TABLE `perfman_node_operation_logs`  (
  ...
  CONSTRAINT `perfman_node_operation_logs_ibfk_1` FOREIGN KEY (`node_id`) REFERENCES `perfman_nodes` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '节点操作历史记录' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for perfman_nodes
-- ----------------------------
DROP TABLE IF EXISTS `perfman_nodes`;
CREATE TABLE `perfman_nodes`  (
...
-- ----------------------------
-- Table structure for perfman_notification_settings
-- ----------------------------
DROP TABLE IF EXISTS `perfman_notification_settings`;
CREATE TABLE `perfman_notification_settings`  (
  ...
  CONSTRAINT `perfman_notification_settings_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `perfman_user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
-- ----------------------------
-- Table structure for perfman_project_invitations
-- ----------------------------
DROP TABLE IF EXISTS `perfman_project_invitations`;
CREATE TABLE `perfman_project_invitations`  (
  ...
  CONSTRAINT `perfman_project_invitations_ibfk_1` FOREIGN KEY (`project_id`) REFERENCES `perfman_projects` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `perfman_project_invitations_ibfk_2` FOREIGN KEY (`inviter_id`) REFERENCES `perfman_user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '项目邀请信息，包括邀请状态、邀请码、邀请链接等' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for perfman_project_members
-- ----------------------------
DROP TABLE IF EXISTS `perfman_project_members`;
CREATE TABLE `perfman_project_members`  (
  ...
  INDEX `project_id`(`project_id` ASC) USING BTREE,
  INDEX `user_id`(`user_id` ASC) USING BTREE,
  CONSTRAINT `perfman_project_members_ibfk_1` FOREIGN KEY (`project_id`) REFERENCES `perfman_projects` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `perfman_project_members_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `perfman_user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '项目成员信息及角色' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for perfman_projects
-- ----------------------------
DROP TABLE IF EXISTS `perfman_projects`;
CREATE TABLE `perfman_projects`  (
...
-- ----------------------------
-- Table structure for perfman_role_menus
-- ----------------------------
DROP TABLE IF EXISTS `perfman_role_menus`;
CREATE TABLE `perfman_role_menus`  (
  ...
  CONSTRAINT `perfman_role_menus_ibfk_1` FOREIGN KEY (`role_id`) REFERENCES `perfman_roles` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `perfman_role_menus_ibfk_2` FOREIGN KEY (`menu_id`) REFERENCES `perfman_menus` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '角色与菜单项的多对多关系，控制菜单访问权限' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for perfman_role_permissions
-- ----------------------------
DROP TABLE IF EXISTS `perfman_role_permissions`;
CREATE TABLE `perfman_role_permissions`  (
  `role_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '角色ID',
  `permission_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '权限ID',
  PRIMARY KEY (`role_id`, `permission_id`) USING BTREE,
  INDEX `permission_id`(`permission_id` ASC) USING BTREE,
  CONSTRAINT `perfman_role_permissions_ibfk_1` FOREIGN KEY (`role_id`) REFERENCES `perfman_roles` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `perfman_role_permissions_ibfk_2` FOREIGN KEY (`permission_id`) REFERENCES `perfman_permissions` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '角色权限关系表，角色与权限的多对多关系' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for perfman_roles
-- ----------------------------
DROP TABLE IF EXISTS `perfman_roles`;
CREATE TABLE `perfman_roles`  (
...
-- ----------------------------
-- Table structure for perfman_schedulers
-- ----------------------------
DROP TABLE IF EXISTS `perfman_schedulers`;
CREATE TABLE `perfman_schedulers`  (
  ...
  CONSTRAINT `perfman_schedulers_ibfk_1` FOREIGN KEY (`scenario_id`) REFERENCES `perfman_test_scenarios` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '定时器配置信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for perfman_task_execution_records
-- ----------------------------
DROP TABLE IF EXISTS `perfman_task_execution_records`;
CREATE TABLE `perfman_task_execution_records`  (
  ...
  CONSTRAINT `perfman_task_execution_records_ibfk_1` FOREIGN KEY (`task_id`) REFERENCES `perfman_test_tasks` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '测试任务执行细节' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for perfman_task_logs
-- ----------------------------
DROP TABLE IF EXISTS `perfman_task_logs`;
CREATE TABLE `perfman_task_logs`  (
  `id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '日志唯一标识',
  `task_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '关联的测试任务ID',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `task_id`(`task_id` ASC) USING BTREE,
  CONSTRAINT `perfman_task_logs_ibfk_1` FOREIGN KEY (`task_id`) REFERENCES `perfman_test_tasks` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '测试任务运行日志' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for perfman_test_reports
-- ----------------------------
DROP TABLE IF EXISTS `perfman_test_reports`;
CREATE TABLE `perfman_test_reports`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `task_id`(`task_id` ASC) USING BTREE,
  CONSTRAINT `perfman_test_reports_ibfk_1` FOREIGN KEY (`task_id`) REFERENCES `perfman_test_tasks` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '测试报告存储' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for perfman_test_scenarios
-- ----------------------------
DROP TABLE IF EXISTS `perfman_test_scenarios`;
CREATE TABLE `perfman_test_scenarios`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `project_id`(`project_id` ASC) USING BTREE,
  CONSTRAINT `perfman_test_scenarios_ibfk_1` FOREIGN KEY (`project_id`) REFERENCES `perfman_projects` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '测试场景配置' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for perfman_test_tasks
-- ----------------------------
DROP TABLE IF EXISTS `perfman_test_tasks`;
CREATE TABLE `perfman_test_tasks`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `scenario_id`(`scenario_id` ASC) USING BTREE,
  CONSTRAINT `perfman_test_tasks_ibfk_1` FOREIGN KEY (`scenario_id`) REFERENCES `perfman_test_scenarios` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `perfman_user_cluster_permissions`  (
  ...
  CONSTRAINT `perfman_user_cluster_permissions_ibfk_2` FOREIGN KEY (`cluster_id`) REFERENCES `perfman_clusters` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `perfman_user_node_permissions`  (
  ...
  CONSTRAINT `perfman_user_node_permissions_ibfk_2` FOREIGN KEY (`node_id`) REFERENCES `perfman_nodes` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `perfman_user_roles`  (
  ...
  CONSTRAINT `perfman_user_roles_ibfk_2` FOREIGN KEY (`role_id`) REFERENCES `perfman_roles` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
